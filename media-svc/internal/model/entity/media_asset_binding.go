...
// MediaAssetBinding is the golang structure for table media_asset_binding.
type MediaAssetBinding struct {
	...
	BindingField    string      `json:"bindingField"    orm:"binding_field"     description:"Slot name, e.g. main_images/detail_images/carousel_images"` // Slot name, e.g. main_images/detail_images/carousel_images
