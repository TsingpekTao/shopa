...
// FulfillmentOutboxEvent is the golang structure for table fulfillment_outbox_event.
type FulfillmentOutboxEvent struct {
	...
	Status        uint        `json:"status"        orm:"status"         description:"0 PENDING 1 PUBLISHED 2 FAILED"` // 0 PENDING 1 PUBLISHED 2 FAILED
